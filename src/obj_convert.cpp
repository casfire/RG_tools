...
void Converter::done() {
	...
	if (material.hasEmission)         object.emit         = createVec3(material.emission.r, material.emission.g, material.emission.b);
	if (material.hasSpecularExponent) object.specular_exp = material.specularExponent.value;
	if (material.hasSpecular)         object.specular     = createVec3(material.specular.r, material.specular.g, material.specular.b);
